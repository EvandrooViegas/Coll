      ...
      <div className='flex flex-col items-center justify-center gap-10 my-5'>
        <div className='flex justify-center'> 
          ...
          <div className='flex gap-4'> 
              <button  className='flex justify-center items-center gap-2 px-2 py-1 rounded-sm transition shadow-lg border-[1px] border-black hover:bg-red-500 hover:text-white hover:border-transparent'  
                onClick={() => setModal({isOpen: true, res: true, element: undefined, payload: item, reach: "item"})}>
